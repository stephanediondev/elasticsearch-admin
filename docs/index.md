...
- Feature detection: functionalities available according to enabled features and [Elasticsearch version](elasticsearch-feature-detection)
...
- Nodes: list, stats, read, usage [6.0], plugins, reload secure settings [6.4]
...
- [7.9.0](https://github.com/stephanediondev/elasticsearch-admin/tree/master/screenshots/7.9.0)
