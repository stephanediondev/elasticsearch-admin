...
class AppScreenshotsController extends AbstractAppController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $entries = [
            ...
            ['title' => 'Legacy templates', 'filename' => 'index-templates-legacy', 'path' => '/admin/index-templates-legacy'],
            ['title' => 'Create legacy template', 'filename' => 'index-template-create-legacy', 'path' => '/admin/index-templates-legacy/create'],
