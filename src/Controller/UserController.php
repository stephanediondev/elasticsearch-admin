...
class UserController extends AbstractAppController
{
    ...
    {
        $this->denyAccessUnlessGranted('USERS', 'global');
    ...
    {
        $this->denyAccessUnlessGranted('USERS_CREATE', 'global');
    ...
    {
        $this->denyAccessUnlessGranted('USER_UPDATE', 'global');
    ...
    {
        $this->denyAccessUnlessGranted('USER_DELETE', 'global');
