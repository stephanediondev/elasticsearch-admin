...
class AppRoleManager extends AbstractAppManager
{
    private $attributes = [
        'global' => [
            'CLUSTER_SETTINGS', 'CLUSTER_SETTING_EDIT', 'CLUSTER_SETTING_REMOVE', 'CLUSTER_ALLOCATION_EXPLAIN', 'CLUSTER_AUDIT',
            'NODES',
            ...
            'SHARDS', 'SHARDS_STATS', 'SHARD_MOVE', 'SHARD_ALLOCATE_REPLICA', 'SHARD_CANCEL_ALLOCATION',
            'MENU_CONFIGURATION',
