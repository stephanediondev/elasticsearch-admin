...
class ElasticsearchNodeManager extends AbstractAppManager
{
    ...
    public function getAll(?array $parameters): array
    {
        ...
        $query = ['bytes' => 'b', 'h' => 'name,file_desc.max,node.role,jdk,load_1m,load_5m,load_15m,disk.used_percent,ram.percent,cpu,uptime,master,disk.total,disk.used,disk.avail,ram.current,ram.max,heap.percent,heap.max,heap.current'];
